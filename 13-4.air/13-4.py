...
bujiImg=Template(r"tpl1584107269046.png", record_pos=(0.048, 0.031), resolution=(1440, 810))
zhuliImg=Template(r"tpl1584102672051.png", record_pos=(0.29, 0.0), resolution=(1440, 810))
zhencaImg=Template(r"tpl1584107299547.png", record_pos=(-0.293, 0.176), resolution=(1440, 810))
hanmuImg=Template(r"tpl1584102556381.png", record_pos=(0.23, 0.016), resolution=(1440, 810))
...
number=0
while number<1:
    #if exists(Template(r"tpl1584781122594.png", record_pos=(0.24, 0.052), resolution=(1440, 810))):
        #touch(Template(r"tpl1584781122594.png", record_pos=(0.24, 0.052), resolution=(1440, 810)))
    guanqia=exists(Template(r"tpl1584860922831.png", record_pos=(0.303, 0.144), resolution=(1440, 810)))
    if guanqia:
        touch(guanqia)
        sleep(1)
